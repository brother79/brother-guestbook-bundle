...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('brother_guestbook')
            ...
            ->scalarNode('class')->cannotBeEmpty()->defaultValue('Brother\GuestbookBundle\Form\Type\EntryType')->end()
            ->end()
            ->end()
            ...
            ->scalarNode('class')->cannotBeEmpty()->defaultValue('Brother\GuestbookBundle\Form\Type\EntryEditType')->end()
            ->end()
            ->end()
            ...
            ->scalarNode('class')->cannotBeEmpty()->defaultValue('Brother\GuestbookBundle\Form\Type\EntryReplyType')->end()
            ->end()
            ->end()
            ->end()
            ->end()
